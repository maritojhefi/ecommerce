    ...
    public function defaultPreferenceData()
    {
        ...
        return [
            ...
            "company" => [
                ...
                "site_short_name" => "MT",
                "company_name" => "Macrotienda",
                "company_email" => "contacto@macrobyte.site",
                "company_phone" => "+59163800245",
                "company_street" => "calle Mendez entre av. Victor Paz Estenssoro y calle Avaroa",
                "company_city" => "Tarija",
                "company_state" => "Bolivia",
                "company_zip_code" => "XXX",
                "dflt_lang" => "es",
                "dflt_currency_id" => "3",
                "company_gstin" => "11",
                "company_icon" => "",
